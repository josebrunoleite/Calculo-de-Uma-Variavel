                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="https://media.discordapp.net/attachments/1051206841125842964/1051213883588759562/image.png"
                                alt="Banner" max-height="350px" class="d-flex mt-1" style="margin: 0 auto;width: -webkit-fill-available;">
                ...
                <div class="modal fade" id="exampleModal3" tabindex="-1" onclick="My_Video()"
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img src="https://media.discordapp.net/attachments/981329982422941716/1051979890561392680/image.png" alt="Banner" height="450px" width="1030" class="d-flex mt-1"
                                    style="margin: 0 auto;margin: 0 auto;width: -webkit-fill-available;">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" onclick="My_Video()"
                                    data-bs-dismiss="modal">fechar</button>
